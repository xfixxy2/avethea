...
exports.run = async (client, message, args) => {
 if(message.author.id !== "758786208892715010") if(message.author.id !== "758786208892715010") return message.channel.send("hoop bilader sahip komutu bu");
  ...
  .setFooter("Avethea")
  .setTimestamp()
  .setDescription(`<@${message.author.id}> adlı yetkilimiz tarafından karalisteye alındın! Artık VICTORY' komutlarını kullanamazsın. Karalisteye alınma sebebin: **${sebep}**`)
